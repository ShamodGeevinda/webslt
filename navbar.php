<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="compactSidebar">
        ...
        <ul class="menu-categories">
            ...
            <li class="menu menu-single">
                <a target="_blank" href="https://designreset.com/cork/documentation/index.html" data-active="false" class="menu-toggle">
                    <div class="base-menu">
                        <div class="base-icons">
    ...
    <div id="compact_submenuSidebar" class="submenu-sidebar">
        ...
        <div class="submenu" id="dashboard">
            <ul class="submenu-list" data-parent-element="#dashboard">
                <li>
                    <a href="add_user_inter.php"> Add user </a>
                </li>
                <li>
                    <a href="edit_user_inter.php"> Edit user </a>
                </li>
                <li>
                    <a href="delete_user_inter.php"> Delete user </a>
                </li>
            </ul>
        </div>
